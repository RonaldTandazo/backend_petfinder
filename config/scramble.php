...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API de PetFinder: gestión de mascotas, adopciones, mascotas perdidas, refugios y almacenamiento de imágenes (MinIO/S3). Autenticación por Bearer token (Laravel Sanctum) — usa "Authorize" con el token obtenido en /auth/login o /auth/register.',
    ],
